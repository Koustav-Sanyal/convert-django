    ...
    $(document).ready(function() {
        ...
        if($('#lgx-typed-string').length){
            $('#lgx-typed-string').typed({
                strings: ["NIT DURGAPUR", "NIT DURGAPUR","NIT DURGAPUR"],
                // typing speed
                typeSpeed: 10,
        ...
        if (typeof google != 'undefined') {
            ...
            if ($('.map-canvas-default').length) {
                $(".map-canvas-default").googleMap({
                    ...
                    coords: [23.5246664, 87.2671266], // Map center (optional)
                ...
                $(".map-canvas-default").addMarker({
                    coords: [23.5246664, 87.2671266], // GPS coords
                    title: 'ContactPoint',
                    text: 'NIT Durgapur,West Bengal,India',
            ...
            if ($('.map-canvas-dark').length) {
                $(".map-canvas-dark").googleMap({
                    zoom: 15, // Initial zoom level (optiona
                    coords: [23.5396955, 87.2945026], // Map center (optional)
                ...
                $(".map-canvas-dark").addMarker({
                    coords: [23.5396955, 87.2945026], // GPS coords
                    title: 'ContactPoint',
                    text: 'NIT Durgapur,West Bengal,India',
                    icon: lgx_path + '/assets/img/map/map-icon.png'
                });

...
$admin_email_to        = 'istenitdurgapur@gmail.com'; /* Admin Email; Who Will Get The Contact Email Alert */

$admin_email_name   = "ISTE NIT DURGAPUR"; /* Admin Name/Company name who will get the email alert */

$admin_email_from       = 'istenitdurgapur@gmail.com'; /* Admin email from which email address email will be sent */

$admin_email_from_name  = 'ISTE NIT DURGAPUR'; /* Admin name from which email will be sent */


$use_custom_subject = false; /* If you want to use custom subject then set true. To use form subject just ignore it. */

$admin_email_subject = 'A new message from ISTE NIT Durgapur'; /* Custom email subject what the admin will get as contact email alert*/
